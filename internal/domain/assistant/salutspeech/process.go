...
func (ss *Client) StartWorkers(ctx context.Context, n int) {
	for i := 0; i < n; i++ {
		go ss.worker(ctx, i+1)
	}
}

func (ss *Client) worker(ctx context.Context, i int) {
...
func (ss *Client) waitResult(ctx context.Context, task *model.Task) {
...
func (ss *Client) RecognizeFile(ctx context.Context, inputAudio *model.InputAudio, funsSaveStatus func(ctx context.Context, id, taskID, fileID, status string) error) (*model.Task, error) {
